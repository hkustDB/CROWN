...
class L4TimeProcessFunctions(val deltaEnumMode: Int) extends BasedProcessFunction[Any, Payload, String](0, 0, "L3ProcessFunction") {
  ...
  override def initstate(): Unit = {
    ...
    val timeDescriptor = new ValueStateDescriptor[Long]("time", BasicTypeInfo.LONG_TYPE_INFO.asInstanceOf[TypeInformation[Long]], 0)
