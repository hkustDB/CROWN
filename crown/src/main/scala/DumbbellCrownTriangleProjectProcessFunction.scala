...
class DumbbellCrownTriangleProjectProcessFunction(val deltaEnumMode: Int) extends BasedProcessFunction[Any, Payload, String](0, 0, "L3ProcessFunction") {
    ...
    override def initstate(): Unit = {
        ...
        leftTriangle = new Triangle("LT", Array("A","B","C"), Array("C"), leftRelation, deltaEnumMode)
        rightRelation = new GeneralizedRelation("right", Array("D"), root, deltaEnumMode, 1) {}
        rightTriangle = new Triangle("RT", Array("D","E","F"), Array("D"), rightRelation, deltaEnumMode)
        ...
        leftRelation.addConnection(Array("C"), leftTriangle)
        rightRelation.addConnection(Array("D"), rightTriangle)
    }
