package experiments.flink.snb2_arbitrary;
...
public class Query implements Executable {
    ...
    public List<Tuple7<Boolean, Integer, Integer, Integer, Integer, Integer, String>> exec() throws Exception {
        ...
        String createTableMessage = resourcesUtil.readResourceFile("snb2_arbitrary/message.sql");
        tableEnv.executeSql(createTableMessage);

        String createTableTag = resourcesUtil.readResourceFile("snb2_arbitrary/tag.sql");
        tableEnv.executeSql(createTableTag);

        String createTableKnows = resourcesUtil.readResourceFile("snb2_arbitrary/knows.sql");
        tableEnv.executeSql(createTableKnows);

        String createTableMessageTag = resourcesUtil.readResourceFile("snb2_arbitrary/messagetag.sql");
        tableEnv.executeSql(createTableMessageTag);

        String query = resourcesUtil.readResourceFile("snb2_arbitrary/query.sql");
