package experiments.flink.snb1_arbitrary;
...
public class Query implements Executable {
    ...
    public List<Tuple7<Boolean, Integer, Integer, Integer, Integer, Integer, String>> exec() throws Exception {
        ...
        String createTableMessage = resourcesUtil.readResourceFile("snb1_arbitrary/message.sql");
        tableEnv.executeSql(createTableMessage);

        String createTablePerson = resourcesUtil.readResourceFile("snb1_arbitrary/person.sql");
        tableEnv.executeSql(createTablePerson);

        String createTableKnows = resourcesUtil.readResourceFile("snb1_arbitrary/knows.sql");
        tableEnv.executeSql(createTableKnows);

        String query = resourcesUtil.readResourceFile("snb1_arbitrary/query.sql");
