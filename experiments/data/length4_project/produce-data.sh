...
log_file="${PARENT_PATH}/log/produce-data-length4_project.log"
...
java -jar ${tools_home}/target/data-tools.jar -p "length4_project" "${SCRIPT_PATH}/${experiment_name}" "func" >> ${log_file} 2>&1
