...
log_file="${PARENT_PATH}/log/produce-data-length3_project.log"
...
java -jar ${tools_home}/target/data-tools.jar -p "length3_project" "${SCRIPT_PATH}/${experiment_name}" "func" >> ${log_file} 2>&1
